    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300">
              Your gateway to world-class education. Find and book your dream college with ease.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/my-college" className="text-gray-300 hover:text-white transition-colors">
                  My College
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="text-gray-300">College Search</li>
              <li className="text-gray-300">Admission Guidance</li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">info@collegebook.com</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">© 2024 CollegeBook. All rights reserved. Built with ❤️ for students worldwide.</p>
        </div>
      </div>
    </footer>
  )
